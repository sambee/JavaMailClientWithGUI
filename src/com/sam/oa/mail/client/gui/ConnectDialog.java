...
public class ConnectDialog extends JDialog {
    ...
    private JTextField smtpPortServerTextField;
    ...
    public ConnectDialog(Frame parent) {
        ...
        settingsPanel.add(serverPortLabel);
        serverPortTextField = new JTextField(25);
        constraints = new GridBagConstraints();
        constraints.gridwidth = GridBagConstraints.REMAINDER;
        constraints.insets = new Insets(5, 5, 0, 5);
        constraints.weightx = 1.0D;
        layout.setConstraints(serverPortTextField, constraints);
        settingsPanel.add(serverPortTextField);
        ...
        JLabel smtpServerPortLabel = new JLabel("SMTP Server Port:");
        constraints = new GridBagConstraints();
        constraints.anchor = GridBagConstraints.EAST;
        constraints.insets = new Insets(5, 5, 5, 0);
        layout.setConstraints(smtpServerPortLabel, constraints);
        settingsPanel.add(smtpServerPortLabel);       
        smtpPortServerTextField = new JTextField(25);
        constraints = new GridBagConstraints();
        constraints.gridwidth = GridBagConstraints.REMAINDER;
        constraints.insets = new Insets(5, 5, 5, 5);
        constraints.weightx = 1.0D;
        layout.setConstraints(smtpPortServerTextField, constraints);
        settingsPanel.add(smtpPortServerTextField);
        ...
        serverPortTextField.setText("110");
        smtpPortServerTextField.setText("25");
        smtpServerTextField.setText("110");
        passwordField.setText("123");
        usernameTextField.setText("swong@localhost");
     }
