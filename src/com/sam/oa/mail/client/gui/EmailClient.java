...
public class EmailClient extends JFrame {
  ...
  /* This is the split panel that holds the messages
    ...
    public EmailClient() {
        ...
        JMenuItem receive = new JMenuItem("Receive",
                KeyEvent.VK_R);
...
//            store.connect();
    ...
    private void referhEmail(){
        ...
        props.setProperty("mail.pop3.host", "localhost");    // pop3服务器
        
        // 创建Session实例对象  
        Session session = Session.getInstance(props);  
        final Store store = session.getStore("pop3");  
        store.connect("localhost","swong@localhost", "123");  
...
//                 downloadingDialog.show();
        ...
        // Show error dialog.
        showError("Unable to connect:" + e.getMessage(), false);
        return;
    }}    
